...
class OpenAIProvider(LLMProvider):
    ...
    def expand_query(self, query: str) -> List[str]:
      """Generate 3 query variations using Open AI."""
...
class GeminiProvider(LLMProvider):
    ...
    def expand_query(self, query: str) -> List[str]:
      ...
      prompt = f'''Given: "{query}"
  Generate 3 alternative search queries for code that is being used for this Q&A. based on overall context of the code, nothing innovative or outside this code context. Return only queries, one per line.'''
